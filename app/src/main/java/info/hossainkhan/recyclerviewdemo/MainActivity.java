...
/**
 * NOTE: This is a auto-generated activity. See disclaimer at:
 * https://github.com/amardeshbd/android-recycler-view-wrap-content#stack-overflow-references
 */
public class MainActivity extends AppCompatActivity
    ...
    protected void onStart() {
        super.onStart();
        Toast.makeText(this, R.string.guide_description, Toast.LENGTH_LONG).show();
    }
    ...
    public boolean onNavigationItemSelected(MenuItem item) {
        ...
        if (id == R.id.demo_without_fix) {
            ...
            intent.setData(Uri.parse(GITHUB_PROJECT_URL));
    ...
    private void hideGuideText() {
        findViewById(R.id.content_guide).setVisibility(View.GONE);
    }
}
